...
public interface InvitationsRepository extends JpaRepository<Invitations, Long> {
    ...
    Invitations findByIdUserAndIdJournalAndAcceptedAndDeclined(Users user, Journal journal, Boolean accept, Boolean decline);
    @Modifying
    ...
    Boolean existsByIdUserAndIdJournalAndDeclined(Users user, Journal journal, Boolean decline);
}
